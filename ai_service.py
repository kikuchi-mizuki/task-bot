    ...
    def extract_dates_and_times(self, text, conversation_history=None):
        ...
        try:
            ...
            system_prompt = (
                ...
                "   例：'18時以降'→'18:00〜22:00'、'終日'→'00:00〜23:59'、'今日'→'現在時刻〜23:59'、'今日から1週間'→'今日〜7日後の23:59'。\n"
                "   **重要：複数日に対して時刻条件がある場合は、各日に対して同じ時刻範囲を適用してください。**\n"
                "   例：'来週18時以降'→来週の各日について'18:00〜22:00'を設定\n"
                "   例：'明日と明後日の午前中'→明日と明後日の各日について'08:00〜12:00'を設定\n"
